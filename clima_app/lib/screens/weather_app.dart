import 'package:clima_app/widgets/buildin_transform.dart';
...
class _WeatherAppState extends State<WeatherApp> {
  ...
  Widget build(BuildContext context) {
    if (locationList[_currentPage].weatherType == 'Soleado') {
      bgImg = 'assets/sunny.jpg';
    } else if (locationList[_currentPage].weatherType == 'Noche') {
      bgImg = 'assets/night.jpg';
    } else if (locationList[_currentPage].weatherType == 'Lluvia') {
      bgImg = 'assets/rainy.jpg';
    } else if (locationList[_currentPage].weatherType == 'Nublado') {
